...
export const VAULT_ABI = [
  ...
  "function getEmployeeEncryptedBalance(address employee) view returns (bytes32 encryptedPrincipal, bytes32 encryptedYieldBonus)",
  "function getEmployeeSettlementBalance(address employee) view returns (uint256 rawPrincipal, uint256 rawYieldBonus)",
  ...
  "function depositPayrollBatch(address[] recipients, bytes32[] fheInputs, uint256[] rawAmounts)",
